document.addEventListener("DOMContentLoaded", function () {
  ...
  if (usuario && usuario.nombre && usuario.id_usuario) {
    ...
    console.log(`Entraste como jefe ${usuario.nombre} con id ${usuario.id_usuario}`);
  }
  ...
  if (logoutBtn) {
    logoutBtn.addEventListener("click", async function () {
      ...
      console.log(`Saliste como jefe ${usuario?.nombre || ""}`);
  ...
  menuItems.forEach((item) => {
    ...
    const menuText = span.textContent.toLowerCase().replace(/\s+/g, " ").trim();
