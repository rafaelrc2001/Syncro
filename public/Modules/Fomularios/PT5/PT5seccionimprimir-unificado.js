...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (btnSalir) {
    btnSalir.addEventListener("click", function () {
      ...
      if (window.location.pathname.includes("PT5imprimir2.html")) {
        window.location.href = "../../Usuario/AutorizarPT.html";
      } else if (window.location.pathname.includes("PT5imprimirseg.html")) {
        window.location.href = "/Modules/SupSeguridad/SupSeguridad.html";
      } else if (window.location.pathname.includes("PT5imprimirsup.html")) {
