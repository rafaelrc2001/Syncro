  ...
  fetch(`http://localhost:3000/api/pt-electrico/${idPermiso}`)
    ...
    .then((data) => {
      ...
      if (data && data.success && data.data) {
        ...
        setText("identifico_equipo_si", permiso.identifico_equipo === "SI" ? "✔" : "");
        setText("identifico_equipo_no", permiso.identifico_equipo === "NO" ? "✔" : "");
        setText("identifico_equipo_na", permiso.identifico_equipo === "NA" ? "✔" : "");
        setText("verifico_identifico_equipo", permiso.verifico_identifico_equipo === "SI" ? "✔" : "");

        setText("fuera_operacion_desenergizado_si", permiso.fuera_operacion_desenergizado === "SI" ? "✔" : "");
        setText("fuera_operacion_desenergizado_no", permiso.fuera_operacion_desenergizado === "NO" ? "✔" : "");
        setText("fuera_operacion_desenergizado_na", permiso.fuera_operacion_desenergizado === "NA" ? "✔" : "");
        setText("verifico_fuera_operacion_desenergizado", permiso.verifico_fuera_operacion_desenergizado === "SI" ? "✔" : "");

        setText("candado_etiqueta_si", permiso.candado_etiqueta === "SI" ? "✔" : "");
        setText("candado_etiqueta_no", permiso.candado_etiqueta === "NO" ? "✔" : "");
        setText("candado_etiqueta_na", permiso.candado_etiqueta === "NA" ? "✔" : "");
        setText("verifico_candado_etiqueta", permiso.verifico_candado_etiqueta === "SI" ? "✔" : "");

        setText("suspender_adyacentes_si", permiso.suspender_adyacentes === "SI" ? "✔" : "");
        setText("suspender_adyacentes_no", permiso.suspender_adyacentes === "NO" ? "✔" : "");
        setText("suspender_adyacentes_na", permiso.suspender_adyacentes === "NA" ? "✔" : "");
        setText("verifico_suspender_adyacentes", permiso.verifico_suspender_adyacentes === "SI" ? "✔" : "");

        setText("area_limpia_libre_obstaculos_si", permiso.area_limpia_libre_obstaculos === "SI" ? "✔" : "");
        setText("area_limpia_libre_obstaculos_no", permiso.area_limpia_libre_obstaculos === "NO" ? "✔" : "");
        setText("area_limpia_libre_obstaculos_na", permiso.area_limpia_libre_obstaculos === "NA" ? "✔" : "");
        setText("verifico_area_limpia_libre_obstaculos", permiso.verifico_area_limpia_libre_obstaculos === "SI" ? "✔" : "");

        setText("libranza_electrica_si", permiso.libranza_electrica === "SI" ? "✔" : "");
        setText("libranza_electrica_no", permiso.libranza_electrica === "NO" ? "✔" : "");
        setText("libranza_electrica_na", permiso.libranza_electrica === "NA" ? "✔" : "");
        setText("verifico_libranza_electrica", permiso.verifico_libranza_electrica === "SI" ? "✔" : "");
