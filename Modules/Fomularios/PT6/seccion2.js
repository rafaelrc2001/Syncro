document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateSection2() {
        ...
        const radioGroups = [
            ...
            { name: 'equipment-identified', message: 'Por favor indique si se identificó el equipo' },
            { name: 'equipment-deenergized', message: 'Por favor indique si el equipo quedó desenergizado' },
            { name: 'equipment-locked', message: 'Por favor indique si se instaló candado' },
            { name: 'area-responsible', message: 'Por favor ingrese el responsable del área' },
            { name: 'work-responsible', message: 'Por favor ingrese el responsable del trabajo' }
        ];
        ...
        const specialProtection = document.querySelector('input[name="special-protection"]:checked');
        if (specialProtection && specialProtection.value === 'SI') {
            ...
            if (!protectionType.value.trim()) {
                ...
                protectionType.addEventListener('input', function() {
                    this.style.borderColor = '#dee2e6';
                }, { once: true });
            }
        }
    ...
    document.querySelectorAll('.verification-grid input[type="radio"]').forEach(radio => {
        radio.addEventListener('change', function() {
    ...
    if (voltageField) {
        voltageField.addEventListener('blur', function() {
            if (this.value && !/^[\d.]+$/.test(this.value)) {
                ...
                alert('Por favor ingrese un valor numérico válido para el nivel de tensión');
                this.focus();
            } else {
                this.style.borderColor = '#dee2e6';
            }
    ...
    document.querySelector('input[name="special-protection"]').addEventListener('change', function() {
        const protectionType = document.getElementById('special-protection-type');
