document.addEventListener("DOMContentLoaded", function () {
  ...
  // --- MODAL DE ADVERTENCIA PARA ELIMINAR ÁREA ---
  let idAreaAEliminar = null;
    ...
    deleteWarningModal.innerHTML = `
      <div class="modal-content">
        <div class="modal-header">
          <h3><i class="ri-error-warning-line"></i> Advertencia</h3>
        </div>
        <div class="modal-body">
          <p>¡Esta acción no tiene vuelta atrás! ¿Estás seguro de que deseas eliminar este registro?</p>
        </div>
