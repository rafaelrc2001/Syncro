document.addEventListener('DOMContentLoaded', function() {
    ...
    // Configurar hora actual por defecto para inicio y fin de apertura
    const startTimeField = document.getElementById('hora-inicio-apertura');
    const endTimeField = document.getElementById('hora-fin-apertura');
    ...
    if (startTimeField && endTimeField) {
        ...
        // Establecer hora de finalización 1 hora después por defecto
    ...
    // Mostrar/ocultar detalles del plomín según selección
