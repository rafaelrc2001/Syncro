document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateSection2() {
        ...
        const maintenanceSelected = document.querySelector('input[name="maintenance-type"]:checked');
        ...
        const otherPlantSelected = document.querySelector('input[name="plant"][value="OTRO"]:checked');
        if (otherPlantSelected) {
            ...
            if (!otherPlantInput.value.trim()) {
                ...
                otherPlantInput.addEventListener('input', function() {
                    this.style.borderColor = '#dee2e6';
                }, { once: true });
            }
        }

        const otherMaintenanceSelected = document.querySelector('input[name="maintenance-type"][value="OTRO"]:checked');
        if (otherMaintenanceSelected) {
            ...
            if (!otherMaintenanceInput.value.trim()) {
                ...
                otherMaintenanceInput.addEventListener('input', function() {
                    this.style.borderColor = '#dee2e6';
                }, { once: true });
            }
        }
